...
const team = [
  ...
  { img: team3, name: "Lyth Elkour", role: "Co-Founder, Sales & Operations", bio: "Built his background in high performance sales before co founding Uplink Ads and expanding into operations with CutPayroll. Known for direct client acquisition, revenue growth, and building AI systems that scale efficiently under pressure. Focused on execution, relationships, and long term business growth.With experience spanning marketing, sales operations, and business management, Lyth focuses on building scalable systems that support long term growth while maintaining a hands on approach with clients and partnerships. His ability to bridge sales, operations, and execution has played a key role in the expansion of multiple ventures.Known for his persistence, communication skills, and results oriented mindset, Lyth remains actively involved in strategy, client relationships, and operational oversight. His approach emphasizes accountability, consistency, and building businesses designed for sustainable growth." },
];
